...
enum {
    INVALID_TOK=-2, ENDOFCOMMAND = -1, DEUX_POINTS, VIRGULE, WHERE, FROM, INTO, AND, OR, OPEQ, OPSUP, OPINF, OPSUPEQ, OPINFEQ, OPNEQ, TYPE_STRING, TYPE_INT, TYPE_FLOAT, STRING_CONSTANT,
