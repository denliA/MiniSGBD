...
enum {
    INVALID_TOK=-2, ENDOFCOMMAND = -1, DEUX_POINTS, VIRGULE, WHERE, FROM, AND, OR, INTO, RECORD, OPEQ, OPSUP, OPINF, OPSUPEQ, OPINFEQ, OPNEQ, STRING_CONSTANT,
    FLOAT_CONSTANT, INT_CONSTANT, PAREN_OUVR, PAREN_FERM, ETOILE, NOM_VARIABLE, TYPE_INT=T_INT, TYPE_FLOAT=T_FLOAT, TYPE_STRING=T_STRING
};
